...
MYSQL_HOST = os.environ.get('DB_HOST') if (os.environ.get('DB_HOST') != None) else "mysqldb"
MYSQL_USER = os.environ.get('DB_USERNAME') if (os.environ.get('DB_USERNAME') != None) else "root"
MYSQL_PWD = os.environ.get('DB_PASSWORD') if (os.environ.get('DB_PASSWORD') != None) else "mysqldb"
MYSQL_DB = os.environ.get('DB_DATABASE') if (os.environ.get('DB_DATABASE') != None) else "stock_data"
MYSQL_PORT = os.environ.get('DB_PORT') if (os.environ.get('DB_PORT') != None) else "3306"
...
def get_hist_data_cache(code, date_start, date_end):
    ...
    if os.path.isfile(cache_file):
        ...
        logger.info(f"######### get data, write cache #########  {code} {date_start} {date_end}")
