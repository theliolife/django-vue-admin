import configparser
from server.settings import CREDENTIALS_PATH

import os
from maotai.imaotai import config as cf
from maotai.imaotai import process
...
def run():
    ...
    while 1:
        ...
        mobile = input("输入手机号[xxxxxxxxxx]:").lstrip().rstrip()
